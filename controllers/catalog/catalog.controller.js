...
const categoryPage = async (req, res, next) => {
    try {
        ...
        if (sortQ === "price_desc")
            sort = { "variants.price": -1, basePrice: -1 };
...
const categoriesPage = async (req, res, next) => {
    try {
        ...
        const catImages = {
            nam: "https://images.unsplash.com/photo-1549298916-b41d501d3772?auto=format&fit=crop&w=600&q=80",
            nu: "https://images.unsplash.com/photo-1525507119028-ed4c629a60a3?auto=format&fit=crop&w=600&q=80",
            "giay-dep":
